...
// mongoose.connect(
//   'mongodb+srv://oup_client:e02pq1vJD4gKBVMH@cluster0.jtray.mongodb.net/shop?retryWrites=true&w=majority',
...
var products = [
  ...
  new Product({
    ...
    tag: 'Equipment',
    noOfProductInStock: 12,
    imagealt: 'fine-test-auto-coding'
  }),
  new Product({
